class Deck {
    ...
    creerDecksJoueurs() {
        ...
        // Distribution initiale des maladies et remèdes
        for (let i = 0; i < 7; i++) {
        ...
        // Mélanger les decks et préparer les mains initiales
        return {
            joueur1: {
